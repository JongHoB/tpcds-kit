...
EXPLAIN (ANALYZE TRUE, BUFFERS TRUE, VERBOSE TRUE, MEMORY TRUE) with customer_total_return as
...
EXPLAIN (ANALYZE TRUE, BUFFERS TRUE, VERBOSE TRUE, MEMORY TRUE) with wscs as
 (select sold_date_sk
        ,sales_price
...
EXPLAIN (ANALYZE TRUE, BUFFERS TRUE, VERBOSE TRUE, MEMORY TRUE) select  dt.d_year 
...
EXPLAIN (ANALYZE TRUE, BUFFERS TRUE, VERBOSE TRUE, MEMORY TRUE) with year_total as (
...
EXPLAIN (ANALYZE TRUE, BUFFERS TRUE, VERBOSE TRUE, MEMORY TRUE) with ssr as
 (select s_store_id,
...
EXPLAIN (ANALYZE TRUE, BUFFERS TRUE, VERBOSE TRUE, MEMORY TRUE) select  a.ca_state state, count(*) cnt
...
EXPLAIN (ANALYZE TRUE, BUFFERS TRUE, VERBOSE TRUE, MEMORY TRUE) select  i_item_id, 
...
EXPLAIN (ANALYZE TRUE, BUFFERS TRUE, VERBOSE TRUE, MEMORY TRUE) select  s_store_name
      ,sum(ss_net_profit)
 from store_sales
     ,date_dim
     ,store,
     ...
     from (
      ...
      WHERE substr(ca_zip,1,5) IN (
                          '74552','19507','22599','29073','21622','42592',
                          '59113','25923','77437','23529','47114',
                          '93923','63269','60892','22467','21340',
                          '72500','72273','97571','34306','76347',
                          '22388','53953','29911','69738','75220',
                          '51070','43721','97691','46199','77534',
                          '67220','24599','75255','19569','40413',
                          '83655','59205','14415','57903','87825',
                          '42371','95672','75963','75366','31171',
                          '24574','27128','88975','11179','27765',
                          '41007','71050','16280','92602','26436',
                          '53285','83843','64232','75092','51383',
                          '54138','26021','78812','14911','46050',
                          '36027','78079','60524','79898','46593',
                          '52871','40905','61921','50260','55810',
                          '92209','28295','64564','29123','62288',
                          '45129','21561','45612','23482','16104',
                          '61192','22407','49392','96697','66992',
                          '27651','46457','34671','66683','46724',
                          '19474','99687','81859','24043','40062',
                          '71390','52814','28664','33277','52460',
                          '28096','67648','23958','53344','87427',
                          '50038','24567','32916','66139','32478',
                          '79276','18203','16754','20781','98085',
                          '63183','37937','60252','50104','78561',
                          '57911','16019','40448','25356','53617',
                          '71915','43213','46802','74723','41515',
                          '95198','11656','53727','28680','18286',
                          '27957','98465','46433','47736','22420',
                          '97240','80908','89063','75386','23161',
                          '72880','35378','88211','93393','22446',
                          '29217','51712','43148','19297','76249',
                          '84631','93266','11052','42857','20342',
                          '25167','99747','24468','13933','17371',
                          '18551','78723','52494','32273','71706',
                          '84163','25092','83569','39327','90230',
                          '30257','45604','82460','33169','56923',
                          '91111','29384','96813','37415','13743',
                          '80562','21273','57859','83464','44207',
                          '24007','46720','38969','75570','86361',
                          '50486','46138','15615','58599','18101',
                          '81538','17126','22850','58956','63906',
                          '70309','90797','78854','38684','65698',
                          '32118','42766','26317','60405','58656',
                          '93753','56535','78053','45005','26500',
                          '60976','63791','45758','90468','93484',
                          '83762','13775','46513','81636','20849',
                          '25029','81948','38410','62184','84079',
                          '14129','18010','27171','52365','32204',
                          '59048','91983','51014','97880','99648',
                          '47765','83796','56296','13444','72603',
                          '85236','83321','30627','31261','46025',
                          '63166','30059','23649','33782','66148',
                          '62911','57058','95506','23260','24550',
                          '91773','84087','42271','76962','80223',
                          '43796','37884','75931','60481','16897',
                          '21720','37910','12692','90045','32467',
                          '15800','72739','98858','28404','33945',
                          '43858','69600','93913','34923','65400',
                          '30507','17777','21422','21716','92009',
                          '39844','36797','27497','11323','97746',
                          '88582','39605','83477','68055','84325',
                          '31466','17598','37906','47406','94651',
                          '12380','46495','80750','84481','24817',
                          '24463','50385','19904','20671','19427',
                          '86966','38388','45580','79009','12283',
                          '16138','94903','75404','14462','74015',
                          '15363','78158','10643','15567','39140',
                          '70738','30666','11512','67943','23797',
                          '75443','10922','18866','19234','15898',
                          '46191','50351','27863','43059','38851',
                          '90907','24426','81741','15214','53473',
                          '20478','41606','17916','93821','45828',
                          '90550','74316','64425','69643','16499',
                          '34159','39637','28378','30386','17316',
                          '26565','66255','33035','36664','15992',
                          '19129','14976','22049','10598','81056',
                          '66348','33764','19165','10828','51409',
                          '46566','22901','62787','32423','28219',
                          '88381','18953','77594','32184')
     intersect
      select ca_zip
...
EXPLAIN (ANALYZE TRUE, BUFFERS TRUE, VERBOSE TRUE, MEMORY TRUE) select case when (select count(*) 
                  from store_sales 
                  where ss_quantity between 1 and 20) > 2850636
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 21 and 40) > 793461
            then (select avg(ss_ext_tax)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 41 and 60) > 506329
            then (select avg(ss_ext_tax)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 61 and 80) > 176584
            then (select avg(ss_ext_tax)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 81 and 100) > 71990
            then (select avg(ss_ext_tax)
                  from store_sales
...
EXPLAIN (ANALYZE TRUE, BUFFERS TRUE, VERBOSE TRUE, MEMORY TRUE) select  
  cd_gender,
  cd_marital_status,
  cd_education_status,
  count(*) cnt1,
 ...
 where
  ...
  ca_county in ('Kandiyohi County','Frontier County','Sequatchie County','Trinity County','Chippewa County') and
...
EXPLAIN (ANALYZE TRUE, BUFFERS TRUE, VERBOSE TRUE, MEMORY TRUE) select avg(ss_quantity)
 ...
 and((ss_addr_sk = ca_address_sk
  ...
  and ca_state in ('ME', 'KY', 'VT')
  and ss_net_profit between 100 and 200  
     ) or
     (ss_addr_sk = ca_address_sk
  and ca_country = 'United States'
  and ca_state in ('WA', 'CO', 'OH')
  and ss_net_profit between 150 and 300  
     ) or
     (ss_addr_sk = ca_address_sk
  and ca_country = 'United States'
  and ca_state in ('VA', 'WV', 'MS')
...
EXPLAIN (ANALYZE TRUE, BUFFERS TRUE, VERBOSE TRUE, MEMORY TRUE) with  cross_items as
...
EXPLAIN (ANALYZE TRUE, BUFFERS TRUE, VERBOSE TRUE, MEMORY TRUE) select  ca_zip
       ,sum(cs_sales_price)
 from catalog_sales
     ,customer
     ,customer_address
...
and cc_county in ('Walker County','Richland County','Franklin Parish','Williamson County',
                  'Ziebach County'
)
and exists (select *
...
EXPLAIN (ANALYZE TRUE, BUFFERS TRUE, VERBOSE TRUE, MEMORY TRUE) select  i_item_id,
 ...
 where cs_sold_date_sk = d_date_sk and
       ...
       c_birth_month in (12,3,9,5,7,10) and
       d_year = 2001 and
...
EXPLAIN (ANALYZE TRUE, BUFFERS TRUE, VERBOSE TRUE, MEMORY TRUE) select  i_brand_id brand_id, i_brand brand, i_manufact_id, i_manufact,
...
EXPLAIN (ANALYZE TRUE, BUFFERS TRUE, VERBOSE TRUE, MEMORY TRUE) select  i_product_name
             ,i_brand
             ,i_class
             ,i_category
...
EXPLAIN (ANALYZE TRUE, BUFFERS TRUE, VERBOSE TRUE, MEMORY TRUE) with frequent_ss_items as 
...
EXPLAIN (ANALYZE TRUE, BUFFERS TRUE, VERBOSE TRUE, MEMORY TRUE) with ssales as
(select c_last_name
      ,c_first_name
      ,s_store_name
      ,ca_state
...
from (select avg(ss_list_price) B1_LP
      ...
      where ss_quantity between 0 and 5
        and (ss_list_price between 119 and 119+10 
             or ss_coupon_amt between 1899 and 1899+1000
     ...
     (select avg(ss_list_price) B2_LP
      ...
      where ss_quantity between 6 and 10
        and (ss_list_price between 61 and 61+10
          or ss_coupon_amt between 7154 and 7154+1000
     ...
     (select avg(ss_list_price) B3_LP
      ...
      where ss_quantity between 11 and 15
        and (ss_list_price between 96 and 96+10
          or ss_coupon_amt between 13229 and 13229+1000
     ...
     (select avg(ss_list_price) B4_LP
      ...
      where ss_quantity between 16 and 20
        and (ss_list_price between 185 and 185+10
          or ss_coupon_amt between 15808 and 15808+1000
...
EXPLAIN (ANALYZE TRUE, BUFFERS TRUE, VERBOSE TRUE, MEMORY TRUE) with ss as
...
EXPLAIN (ANALYZE TRUE, BUFFERS TRUE, VERBOSE TRUE, MEMORY TRUE) select  sum(cs_ext_discount_amt)  as "excess discount amount" 
from 
   catalog_sales 
   ,item 
   ,date_dim
...
EXPLAIN (ANALYZE TRUE, BUFFERS TRUE, VERBOSE TRUE, MEMORY TRUE) select c_last_name
       ,c_first_name
       ,c_salutation
       ,c_preferred_cust_flag
       ,ss_ticket_number
   ...
   (select ss_ticket_number
    ...
    and store.s_county in ('Richland County','Ziebach County','Barrow County','Luce County',
                           'Daviess County','Fairfield County','Walker County','Williamson County')
...
EXPLAIN (ANALYZE TRUE, BUFFERS TRUE, VERBOSE TRUE, MEMORY TRUE) select  i_item_id
 ...
 and i_manufact_id in (782,799,804,860)
...
EXPLAIN (ANALYZE TRUE, BUFFERS TRUE, VERBOSE TRUE, MEMORY TRUE) select  count(*) from (
...
EXPLAIN (ANALYZE TRUE, BUFFERS TRUE, VERBOSE TRUE, MEMORY TRUE) with inv as
...
EXPLAIN (ANALYZE TRUE, BUFFERS TRUE, VERBOSE TRUE, MEMORY TRUE) select  distinct(i_product_name)
 from item i1
...
EXPLAIN (ANALYZE TRUE, BUFFERS TRUE, VERBOSE TRUE, MEMORY TRUE) select  s_store_name, s_store_id,
...
EXPLAIN (ANALYZE TRUE, BUFFERS TRUE, VERBOSE TRUE, MEMORY TRUE) select  asceding.rnk, i1.i_product_name best_performing, i2.i_product_name worst_performing
from(select *
...
EXPLAIN (ANALYZE TRUE, BUFFERS TRUE, VERBOSE TRUE, MEMORY TRUE) select  ca_zip, ca_state, sum(ws_sales_price)
...
EXPLAIN (ANALYZE TRUE, BUFFERS TRUE, VERBOSE TRUE, MEMORY TRUE) select  c_last_name
 ...
 from
   (select ss_ticket_number
    ...
    and store.s_city in ('Five Points','Mount Pleasant','Liberty','Oak Grove','Pleasant Grove') 
...
EXPLAIN (ANALYZE TRUE, BUFFERS TRUE, VERBOSE TRUE, MEMORY TRUE) with v1 as(
...
EXPLAIN (ANALYZE TRUE, BUFFERS TRUE, VERBOSE TRUE, MEMORY TRUE) select sum (ss_quantity)
...
EXPLAIN (ANALYZE TRUE, BUFFERS TRUE, VERBOSE TRUE, MEMORY TRUE) select  channel, item, return_ratio, return_rank, currency_rank from
 (select
 'web' as channel
 ,web.item
 ,web.return_ratio
...
EXPLAIN (ANALYZE TRUE, BUFFERS TRUE, VERBOSE TRUE, MEMORY TRUE) WITH web_v1 as (
select
...
EXPLAIN (ANALYZE TRUE, BUFFERS TRUE, VERBOSE TRUE, MEMORY TRUE) select  * from 
...
EXPLAIN (ANALYZE TRUE, BUFFERS TRUE, VERBOSE TRUE, MEMORY TRUE) with my_customers as (
...
EXPLAIN (ANALYZE TRUE, BUFFERS TRUE, VERBOSE TRUE, MEMORY TRUE) select  i_brand_id brand_id, i_brand brand,
 	sum(ss_ext_sales_price) ext_price
...
EXPLAIN (ANALYZE TRUE, BUFFERS TRUE, VERBOSE TRUE, MEMORY TRUE) with ss as (
 ...
 where i_item_id in (select
     i_item_id
from item
where i_color in ('cream','burlywood','cornsilk'))
 and     ss_item_sk              = i_item_sk
 and     ss_sold_date_sk         = d_date_sk
 and     d_year                  = 1999
 and     d_moy                   = 6
...
EXPLAIN (ANALYZE TRUE, BUFFERS TRUE, VERBOSE TRUE, MEMORY TRUE) with ss_items as
...
EXPLAIN (ANALYZE TRUE, BUFFERS TRUE, VERBOSE TRUE, MEMORY TRUE) with wss as 
 (select d_week_seq,
        ss_store_sk,
        sum(case when (d_day_name='Sunday') then ss_sales_price else null end) sun_sales,
        sum(case when (d_day_name='Monday') then ss_sales_price else null end) mon_sales,
...
EXPLAIN (ANALYZE TRUE, BUFFERS TRUE, VERBOSE TRUE, MEMORY TRUE) select  promotions,total,cast(promotions as decimal(15,4))/cast(total as decimal(15,4))*100
from
...
EXPLAIN (ANALYZE TRUE, BUFFERS TRUE, VERBOSE TRUE, MEMORY TRUE) with cs_ui as
 (select cs_item_sk
...
cross_sales as
 (select i_product_name product_name
  ...
  WHERE  ss_store_sk = s_store_sk AND
         ...
         i_color in ('coral','magenta','red','steel','forest','goldenrod') and
...
EXPLAIN (ANALYZE TRUE, BUFFERS TRUE, VERBOSE TRUE, MEMORY TRUE) select   
 ...
 from (
 	...
 	and ws_ship_mode_sk = sm_ship_mode_sk
        and d_year = 2000
 	and t_time between 54510 and 54510+28800 
...
EXPLAIN (ANALYZE TRUE, BUFFERS TRUE, VERBOSE TRUE, MEMORY TRUE) select i_brand_id brand_id, i_brand brand,t_hour,t_minute,
...
EXPLAIN (ANALYZE TRUE, BUFFERS TRUE, VERBOSE TRUE, MEMORY TRUE) select  i_item_desc
      ,w_warehouse_name
      ,d1.d_week_seq
...
EXPLAIN (ANALYZE TRUE, BUFFERS TRUE, VERBOSE TRUE, MEMORY TRUE) select c_last_name
   ...
   (select ss_ticket_number
    ...
    and store.s_county in ('Richland County','Daviess County','Ziebach County','Franklin Parish')
...
EXPLAIN (ANALYZE TRUE, BUFFERS TRUE, VERBOSE TRUE, MEMORY TRUE) WITH all_sales AS (
 SELECT d_year
       ,i_brand_id
       ,i_class_id
       ,i_category_id
...
EXPLAIN (ANALYZE TRUE, BUFFERS TRUE, VERBOSE TRUE, MEMORY TRUE) select  channel, col_name, d_year, d_qoy, i_category, COUNT(*) sales_cnt, SUM(ext_sales_price) sales_amt FROM (
...
EXPLAIN (ANALYZE TRUE, BUFFERS TRUE, VERBOSE TRUE, MEMORY TRUE) with ws as
...
EXPLAIN (ANALYZE TRUE, BUFFERS TRUE, VERBOSE TRUE, MEMORY TRUE) select  i_item_id
 ...
 and i_manufact_id in (389,617,338,189)
 and inv_quantity_on_hand between 100 and 500
 and ss_item_sk = i_item_sk
 group by i_item_id,i_item_desc,i_current_price
 order by i_item_id
...
EXPLAIN (ANALYZE TRUE, BUFFERS TRUE, VERBOSE TRUE, MEMORY TRUE) with sr_items as
 (select i_item_id item_id,
 ...
 and   d_date    in 
	...
	where d_week_seq in 
		(select d_week_seq
		from date_dim
	  where d_date in ('2001-07-12','2001-08-08','2001-11-05')))
...
EXPLAIN (ANALYZE TRUE, BUFFERS TRUE, VERBOSE TRUE, MEMORY TRUE) select  c_customer_id as customer_id
 ...
 where ca_city	        =  'Harmony'
   and c_current_addr_sk = ca_address_sk
   and ib_lower_bound   >=  35397
   and ib_upper_bound   <=  35397 + 50000
...
EXPLAIN (ANALYZE TRUE, BUFFERS TRUE, VERBOSE TRUE, MEMORY TRUE) select  substr(r_reason_desc,1,20)
       ,avg(ws_quantity)
...
EXPLAIN (ANALYZE TRUE, BUFFERS TRUE, VERBOSE TRUE, MEMORY TRUE) select count(*) 
...
where ss_item_sk = i_item_sk and
      ...
      d_year in (1999) and
        ((i_category in ('Home','Sports','Shoes') and
          i_class in ('tables','hockey','kids')
         )
      or (i_category in ('Children','Books','Men') and
          i_class in ('school-uniforms','fiction','pants') 
        ))
...
EXPLAIN (ANALYZE TRUE, BUFFERS TRUE, VERBOSE TRUE, MEMORY TRUE) select  cast(amc as decimal(15,4))/cast(pmc as decimal(15,4)) am_pm_ratio
...
EXPLAIN (ANALYZE TRUE, BUFFERS TRUE, VERBOSE TRUE, MEMORY TRUE) select  ss_customer_sk
...
EXPLAIN (ANALYZE TRUE, BUFFERS TRUE, VERBOSE TRUE, MEMORY TRUE) with ws_wh as
...
EXPLAIN (ANALYZE TRUE, BUFFERS TRUE, VERBOSE TRUE, MEMORY TRUE) with ssci as (
